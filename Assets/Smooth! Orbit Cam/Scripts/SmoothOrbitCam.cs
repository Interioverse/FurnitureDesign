...
public class SmoothOrbitCam : MonoBehaviour
{
    ...
    public void SetCamPosition(string modelName, string modelType)
    {
        if (modelType == "Appliances")
        {
            SetValues(2, 2, 3, 0);
        }
        else if (modelType == "Automobile")
        {
            SetValues(4, 4, 8, 0);
        }
        else if (modelType == "Decor")
        {
            SetValues(4, 4, 8, 0.5f);
        }
        else if (modelType == "Education")
        {
            SetValues(1, 1, 2, 0.2f);
        }
        else if (modelType == "Electronics")
        {
            SetValues(2, 2, 3, 0);
        }
        else if (modelType == "Fashion")
        {
            SetValues(3, 3, 5, 0.5f);
        }
        else if (modelType == "Food")
        {
            SetValues(0.8f, 0.8f, 1, -0.05f);
        }
        else if (modelType == "Machines")
        {
            SetValues(3, 3, 6, 0);
        }
        ...
        else if (modelType == "RealEstate")
        {
            SetValues(6, 6, 8, 0.5f);
        }
        else if (modelType == "Renewable")
        {
            SetValues(10, 10, 20, 1.2f);
        }
        else if (modelType == "Tourism")
        {
            SetValues(3, 3, 5, 0.2f);
        }
        else
        {
            //Default
    ...
    void SetValues(float dist, float distMin, float distMax, float yOfst)
    {
        distance = dist;
        distanceMin = distMin;
        distanceMax = distMax;
    ...
    internal void ResetCamOrientation()
    {
    ...
    void Update()
	{
        ...
        if (designRoom && designRoom.activeSelf)
        {
        ...
        else if (View360Room && View360Room.activeSelf)
        {
            EnableOrbiting = true;
        }
        else if (adminRoom && adminRoom.activeSelf && !isUIDragging)
        {
            EnableOrbiting = true;
        }
        else
        ...
        //{
        //    enableAutomaticOrbiting = !enableAutomaticOrbiting;
        //    ChangeIcon(enableAutomaticOrbiting);
        //}
    }

    public GameObject showRoom, designRoom, View360Room, adminRoom;
    public Sprite pause, play;
    public Image playPause;

    public void PlayPauseOrbit()
    {
        enableAutomaticOrbiting = !enableAutomaticOrbiting;
        ChangeIcon(enableAutomaticOrbiting);
    }
