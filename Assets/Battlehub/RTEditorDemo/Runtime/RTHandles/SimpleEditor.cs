...
namespace Battlehub.RTHandles.Demo
{
    ...
    {
        [SerializeField]
        public Toggle m_viewToggle = null;

        [SerializeField]
        public Toggle m_positionToggle = null;

        [SerializeField]
        public Toggle m_rotationToggle = null;

        [SerializeField]
        public Toggle m_scaleToggle = null;

        [SerializeField]
        public Toggle m_rectToggle = null;
        ...
        {
            if ((Editor.Input.GetKey(KeyCode.LeftControl) || Editor.Input.GetKey(KeyCode.LeftCommand)) && Editor.Input.GetKeyDown(KeyCode.Z))
            {
                if (m_undoButton) m_undoButton.onClick.AddListener(OnUndoClick);
            }
            else if ((Editor.Input.GetKey(KeyCode.LeftControl) || Editor.Input.GetKey(KeyCode.LeftCommand)) && Editor.Input.GetKeyDown(KeyCode.Y))
            {
