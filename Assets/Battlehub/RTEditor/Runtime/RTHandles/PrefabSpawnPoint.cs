...
namespace Battlehub.RTHandles
{
    public class PrefabSpawnPoint : MonoBehaviour, IInitializePotentialDragHandler, IBeginDragHandler, IDragHandler, IEndDragHandler
    {
        ...
        protected virtual GameObject InstantiatePrefab(GameObject prefab, Vector3 point, Quaternion rotation)
        {
            ...
            instance.transform.parent = newFurniture;
            return instance;
        }

        public Transform newFurniture;
        ...
        public virtual void OnBeginDrag(PointerEventData eventData)
        {
            ...
            exposeToEditor.SetName(m_prefab.name + "_" + UnityEngine.Random.Range(1, 9999999));
        ...
        public virtual void OnEndDrag(PointerEventData eventData)
        {
            if (m_prefabInstance != null)
            {
                ...
                m_prefabInstance.transform.localPosition = new Vector3(m_prefabInstance.transform.localPosition.x, 0.5f, m_prefabInstance.transform.localPosition.z);
            }
