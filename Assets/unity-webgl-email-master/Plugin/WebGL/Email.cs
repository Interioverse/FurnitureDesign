...
namespace UE.Email
{
    ...
    public static partial class Email
    {
        ...
        private static extern void SendMail(string from, string to, string subject, string body, string smtp, string user, string password);

        [DllImport("__Internal")]
        private static extern void SendMailToken(string from, string to, string subject, string body, string token);

        [DllImport("__Internal")]
        private static extern void SendMailTokenWithAttachment(string from, string to, string subject, string body, string token, string attachment);
        ...
        public static void SendEmail(string from, string to, string subject, string body, string smtp, string user, string password)
        {
